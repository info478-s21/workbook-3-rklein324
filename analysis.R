...
ggplot(data_2016) +
  ...
  labs(title = "HALE vs DALYs",
       x = "HALE",
       y = "DALYs")
ggsave("charts/hale_dalys_plot.png")
...
ggplot(data_wide) +
  ...
  labs(title = "Difference in Life Expectancey vs HALE (2016 - 1990)",
...
# This means that as life expectancy increases HALE increases as well,
